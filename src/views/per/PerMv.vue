    ...
    <div>
      <el-card style="margin-top: 10px">
        <div style="display: flex;justify-content: space-between;">
          ...
          <el-button-group>
            <el-tooltip effect="dark" content="隐藏/显示搜索" placement="top" popper-class="mvPopper">
              <el-button class="group_button" icon="fa fa-search" @click="showSearchView = !showSearchView"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="刷新" placement="top" popper-class="mvPopper">
              <el-button class="group_button" icon="el-icon-refresh" @click="initEmpRemoves"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="列" placement="top" popper-class="mvPopper">
              <el-popover
                  placement="bottom"
                  trigger="click"
                  popper-class="mv-popover"
                  :width="100">
                <div>
...
<style>
.mvPopper.el-tooltip__popper {
  background: #6c6c6c;
  padding: 3px 6px;
  height: 15px;
  line-height: 15px;
}
.mvPopper.el-tooltip__popper.is-dark {
  background: #6c6c6c;
}
.mvPopper.el-tooltip__popper[x-placement^="top"] .popper__arrow:after, .mvPopper.el-tooltip__popper[x-placement^="top"] .popper__arrow {
  border-top-color: #6c6c6c;
  opacity: 1;
}
.el-popover.mv-popover{
  min-width: 100px;
}
</style>
<style scoped>
