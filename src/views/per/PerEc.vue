    ...
    <div>
      <el-card style="margin-top: 10px">
        <div style="display: flex;justify-content: space-between;">
          ...
          <el-button-group>
            <el-tooltip effect="dark" content="隐藏/显示搜索" placement="top" popper-class="ecPopper">
              <el-button class="group_button" icon="fa fa-search" @click="showSearchView = !showSearchView"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="刷新" placement="top" popper-class="ecPopper">
              <el-button class="group_button" icon="el-icon-refresh" @click="initEmpEcs"></el-button>
            </el-tooltip>
            <el-tooltip effect="dark" content="列" placement="top" popper-class="ecPopper">
              <el-popover
                  placement="bottom"
                  trigger="click"
                  popper-class="ec-popover"
                  :width="100">
                <div>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="员工姓名" prop="employee.name">
                <el-input style="width: 240px;" v-model="ec.employee.name"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="工号" prop="employee.workId">
                <el-input style="width: 240px;" v-model="ec.employee.workId"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="奖惩原因" prop="ecId">
                <el-select v-model="ec.ecId" style="margin-left: -1px;width: 240px;" clearable placeholder="选择奖惩原因">
...
<style>
.ecPopper.el-tooltip__popper {
  background: #6c6c6c;
  padding: 3px 6px;
  height: 15px;
  line-height: 15px;
}
.ecPopper.el-tooltip__popper.is-dark {
  background: #6c6c6c;
}
.ecPopper.el-tooltip__popper[x-placement^="top"] .popper__arrow:after, .ecPopper.el-tooltip__popper[x-placement^="top"] .popper__arrow {
  border-top-color: #6c6c6c;
  opacity: 1;
}
.el-popover.ec-popover{
  min-width: 100px;
}
</style>
<style scoped>
