  ...
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        ...
        <div>
          <el-upload action="/personnel/emp/import"
                     :headers="headers"
  ...
  methods:{
    ...
    deleteEmp(data){
      this.$confirm('此操作将永久删除员工['+data.name+'], 是否继续?', '提示', {
        ...
        this.$deleteRequest('/personnel/emp/'+data.id).then(res=>{
          if(res){
            this.initEmps();
          }
        })
    ...
    doAddEmp(){
      if(this.emp.id){
        this.$refs['empForm'].validate(valid=>{
          if(valid){
            this.$putRequest('/personnel/emp/',this.emp).then(res=>{
              if(res){
        ...
        this.$refs['empForm'].validate(valid=>{
          if(valid){
            this.$postRequest('/personnel/emp/',this.emp).then(res=>{
              if(res){
                this.dialogVisible = false;
                this.visible = false;
                this.initEmps();
